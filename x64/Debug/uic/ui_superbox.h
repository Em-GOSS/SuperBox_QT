...
public:
    ...
    QGraphicsView *PowerUI;
    QGraphicsView *BulletSlot;
    QPushButton *SaveIcon;
    ...
    void setupUi(QMainWindow *SuperBoxClass)
    {
        ...
        SuperBoxClass->resize(960, 478);
        SuperBoxClass->setMinimumSize(QSize(960, 478));
        SuperBoxClass->setMaximumSize(QSize(960, 480));
        QPalette palette;
        QBrush brush(QColor(232, 183, 135, 255));
        ...
        SuperBoxClass->setPalette(palette);
        QFont font;
        font.setFamily(QString::fromUtf8("Pixel Number"));
        SuperBoxClass->setFont(font);
...
"border-image: url(:/image/mfc_Button2.bmp);"));
        ...
        Bag_BackGround->setGeometry(QRect(357, 52, 280, 120));
        ...
        slot4->setGeometry(QRect(577, 70, 40, 42));
        ...
        slot3->setGeometry(QRect(527, 70, 40, 42));
        ...
        slot8->setGeometry(QRect(527, 115, 40, 42));
        ...
        slot2->setGeometry(QRect(476, 70, 41, 42));
        ...
        slot9->setGeometry(QRect(577, 115, 40, 42));
...
""));
        ...
        slot6->setGeometry(QRect(426, 115, 40, 42));
        ...
        slot1->setGeometry(QRect(426, 70, 40, 42));
        ...
        slot5->setGeometry(QRect(376, 115, 40, 42));
        ...
        slot7->setGeometry(QRect(476, 115, 41, 42));
        ...
        slot0->setGeometry(QRect(376, 70, 40, 42));
        ...
        Fox->setGeometry(QRect(480, 10, 34, 34));
        Fox->setLayoutDirection(Qt::LeftToRight);
...
""));
        ...
        font3.setWeight(75);
        Property_AttackLabel->setFont(font3);
        ...
        Property_DefenceLabel->setFont(font3);
        ...
        Property_HPLabel->setFont(font3);
...
""));
        ...
        PowerUI = new QGraphicsView(centralWidget);
        PowerUI->setObjectName(QString::fromUtf8("PowerUI"));
        PowerUI->setGeometry(QRect(90, 340, 76, 76));
        PowerUI->setStyleSheet(QString::fromUtf8("border-image: url(:/image/PowerUI.bmp);"));
        BulletSlot = new QGraphicsView(centralWidget);
        BulletSlot->setObjectName(QString::fromUtf8("BulletSlot"));
        BulletSlot->setGeometry(QRect(170, 350, 64, 64));
        BulletSlot->setStyleSheet(QString::fromUtf8("border-image: url(:/image/BulletSlot.bmp);\n"
"\n"
""));
        SaveIcon = new QPushButton(centralWidget);
        SaveIcon->setObjectName(QString::fromUtf8("SaveIcon"));
        SaveIcon->setGeometry(QRect(910, 10, 35, 35));
        QPalette palette1;
        QBrush brush2(QColor(210, 181, 205, 255));
        brush2.setStyle(Qt::SolidPattern);
        palette1.setBrush(QPalette::Active, QPalette::WindowText, brush2);
        QBrush brush3(QColor(213, 200, 212, 255));
        brush3.setStyle(Qt::SolidPattern);
        palette1.setBrush(QPalette::Active, QPalette::Button, brush3);
        QBrush brush4(QColor(255, 169, 171, 255));
        ...
        SaveIcon->setPalette(palette1);
        SaveIcon->setFont(font);
        SaveIcon->setStyleSheet(QString::fromUtf8("background-image: url(:/image/LoadSystem/Save_Icon.bmp);"));
    ...
    void retranslateUi(QMainWindow *SuperBoxClass)
    {
        ...
        SaveIcon->setText(QApplication::translate("SuperBoxClass", "1", nullptr));
    } // retranslateUi
